...
[출력 형식]
- 서술체로 쓴다: 개조식 단어 나열이 아니라 완결된 문장과 짧은 문단으로, 한국 애널리스트 리포트 문장처럼 자연스럽게. 단 '핵심 실적 vs 컨센서스'와 '특이사항 & 핵심 KPI'의 수치 항목은 bullet로 나열해도 된다.
...
<b>💬 경영진 핵심 메시지</b>
한 문단(3~4문장)의 서술체로 전체 실적 흐름, 강했던·약했던 사업부·지역·제품, 수요·가격·물량·믹스·마진, 다음 분기 또는 하반기 핵심 변수를 자연스럽게 엮는다. 개별 KPI 수치를 여기서 나열하지 말고 흐름과 해석 위주로 쓴다.
